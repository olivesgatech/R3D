...
from data.basedataset_nturgbd import BaseDataset
...
from predict_nturgbd import predict
...
def main(seed, dataset_ops):
    ...
    elif dataset == 'nturgbd':
        data_path = './datasets/nturgbd'
    ...
    if args.predict :
        ...
        if args.dataset == 'breakfast' :
            ...
            model_path = f'/home/hice1/skim3513/scratch/darai-anticipation/FUTR_proposed/save_dir/nturgbd/long/model/transformer/1/i3d_transcript/runs0/_{dataset_ops}/seed_{seed}_best.ckpt'
